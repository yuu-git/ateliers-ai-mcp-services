...
/// <summary>
/// VOICEPEAK 用のコンテンツ生成ナレッジオプション
/// </summary>
public class VoicePeakGenerationKnowledgeOptions : IMcpContentGenerationKnowledgeOptions
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// 現在はローカルファイルのみをサポートしており、デフォルトでは "knowledge/voicepeak_knowledge.md" を使用します。
    /// </remarks>
    public string KnowledgeSource { get; init; } = "knowledge/voicepeak_knowledge.md";
    ...
    /// ナレッジの説明
    /// </summary>
    public string Discription { get; init; } = "VOICEPEAK用の音声生成ナレッジ";
