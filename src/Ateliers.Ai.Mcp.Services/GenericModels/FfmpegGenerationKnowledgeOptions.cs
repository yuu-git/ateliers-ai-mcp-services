...
/// <summary>
/// FFmpeg 用のコンテンツ生成ナレッジオプション
/// </summary>
public class FfmpegGenerationKnowledgeOptions : IMcpContentGenerationKnowledgeOptions
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// 現在はローカルファイルのみをサポートしており、デフォルトでは "knowledge/ffmpeg_knowledge.md" を使用します。
    /// </remarks>
    public string KnowledgeSource { get; init; } = "knowledge/ffmpeg_knowledge.md";
    ...
    /// ナレッジの説明
    /// </summary>
    public string Discription { get; init; } = "FFmpeg用の動画合成ナレッジ";
